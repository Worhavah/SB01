...
public class DownloadActivity extends Activity {
 ...
 //   private ImageView iv;
    private String U1="http://22.189.22.40/downtest/";
    private String[] u2=new String[]{"111.txt","H1.mp3","H2.mp3","wamp2.5.rar"};
    private String U3="http://22.189.22.41/downLoad/1.apk";
    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_downloaddemo);

        llsApkFilePath = FileDownloadUtils.getDefaultSaveRootPath() +File.separator + "hahadowmload"+File.separator;
        //llsApkFilePath =  getCommonPath();
    ...
    public  String getCommonPath() {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment
          ...
          //  String path = sdcardDir.getPath() + "/" + "hahahadownload";
            String path = Environment.getDownloadCacheDirectory().getPath()+"/" + "hahahadownload";
    ...
    private BaseDownloadTask createDownloadTask(final int position) {
        ...
        switch (position) {
            ...
            case 2:
                ...
                path = llsApkFilePath+u2[1];
                isDir = false;
                /*path = llsApkFilePath;  不存名字
                isDir = true;*/
    ...
    private void assignViews() {
      ...
      //  iv= (ImageView) findViewById(R.id.iv_tt);
    }

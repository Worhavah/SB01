...
public class PluginActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_start_demo1).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 刻意以“包名”来打开
                final ProgressDialog pd = ProgressDialog.show(PluginActivity.this, "Installing...", "Please wait...", true, true);
        ...
        findViewById(R.id.btn_start_plugin_for_result).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        RePlugin.startActivity(PluginActivity.this, RePlugin.createIntent("com.zztzt.android.simple.app", "com.zztzt.android.simple.app.MainActivity"));
    ...
    private void simulateInstallExternalPlugin() {
       // String demo3Apk= "demo3.apk";
        ...
        if (info != null) {
            RePlugin.startActivity(PluginActivity.this, RePlugin.createIntent(info.getName(), "com.zztzt.android.simple.app.MainActivity"));
        } else {
            Toast.makeText(PluginActivity.this, "install external plugin failed", Toast.LENGTH_SHORT).show();
        }
    }
